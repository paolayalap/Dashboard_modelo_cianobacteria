# ============================================
# Streamlit: CEA — Clorofila
# - Entrena con DATOS CEA.csv
# - Predice Clorofila en el estanque
...
# --- Estado global: regresor para predicción continua ---
TRAIN_SCALER = None
...
# ---------- Fuzzy helpers (Clorofila: 4 clases) ----------
...
with col_curve:
    if not KERAS_OK:
        ...
        TRAIN_SCALER = None; TRAIN_MODEL_CHL = None
        TRAIN_Y_LOG1P_CHL = False
    else:
        ...
        if fig_loss is not None:
            ...
            st.info("No hay suficientes filas válidas para entrenar el regresor.")
...
if clicked:
    ...
    # --- Predicción continua con modelo CEA ---
